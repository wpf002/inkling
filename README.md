...
- [x] Complete `docs/consent.md`, `docs/inferences.md`, `docs/reveal-sequence.md`
- [x] DB schema + alembic migrations
- [x] Consent flow UI
- [x] Self-report UI

### Phase 1 — First round end-to-end (weeks 2–3) — DONE

- [x] Round 1 (Choice) UI
- [x] Behavioral event capture (timing, hesitation, abandons)
